...
<html>
    ...
    <body> <!-- Inicio/Cuerpo -->
        <div class="contenedor"> <!-- Inicio/Contenedor -->
            <header class="cabecera">  <!-- Inicio/Cabecera -->
                <h3>Compra Directa</h3>
            </header> <!-- Final/Cabecera -->
            <main class="cuerpoUp"> <!-- Contenedor -->
                <article class="alta-contrato"> <!-- Inicio/Compra directa -->
                    <table class="TablaP"> 
                        <tr> 
                        ...
                        <tr> 
                            ...
                            <td class="celda"> <input type="text" class="input_1" name="pedido" id="pedido" placeholder="Ingrese Pedido..." autocomplete="off"> </td> <!-- Contrato -->
                            <td class="celda"> <input type="date" class="input_1" name="fecha" id="fecha" autocomplete="off"> </td> <!-- Fecha -->
                            <td class="celda">
                ...
                </article>  <!-- Fin/Compra directa -->
                <article class="alta-contrato"> <!-- Inicio/Busqueda -->
                    ...
                    <table class="TablaP"> 
                        ...
                        <tr> <!-- Entrada (Articulo,Nombre,Unidad) -->
                            ...
                            <td class="celda" id="product"> <input type="text" class="input_1_show" name="nombre" id="nombre" readonly > </td> <!-- Nombre -->
                            <td class="celda" id="unit"> <input type="text" class="input_1_show" name="unidad" id="unidad" readonly > </td> <!-- Unidad -->
                        </tr> 
                        <tr> 
                            <!-- Titulo (Descripcion) -->
                        ...
                        <tr> 
                            ...
                            <td class="celda"> <input type="text" class="input_1" name="cantidad" id="cantidad"  placeholder="  Ingrese Cantidad"  autocomplete="off"> </td> <!-- Cantidad -->
                            <td class="celda"> <input type="text" class="input_1" name="indice" id="indice"  placeholder="  Ingrese Indice"  autocomplete="off"> </td> <!-- Iva -->
                        </tr> 
                    </table>
                    <div class="botones">
                ...
                <div class="CuerpoDown"> <!-- Inicio/Tabla producto -->
                    <table class="alta-Articulo">
                        ...
                        <tfoot>
                        <tr class="tfoot">
                            <td  class="show-total" colspan="3"> <p class="sub-total">SUBTOTAL</p> </td>
                            <td class="show-total" colspan="3"> <p class="iva">IVA</p> </td>
                            <td class="show-total" colspan="3"> <p class="total">TOTAL</p> </td>
                        </tr>
                ...
                <!--------------------------------- Inicio/Modal --------------------------------->
                <div class="modal-container" id="modal_container_Partida"> <!-- Inicio/Modal partida -->
                    <div class="modal">
                ...
                <div class="modal-container" id="modal_container_FF"> <!-- Inicio/Modal financiamiento -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_Programa"> <!-- Inicio/Modal programa -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_UnidadA"> <!-- Inicio/Modal centro -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_Provedor"> <!-- Inicio/Modal proveedor -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_Producto"> <!-- Inicio/Modal producto -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_Unidad"> <!-- Inicio/Modal unidad -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
                ...
                <div class="modal-container" id="modal_container_Categoria"> <!-- Inicio/Modal categoria -->
                    <div class="modal">
                        <div class="contenedorModal">
                        <header class="cabeceraModal">
                            <!-- Cabecera -->
...
<script>
  function capturar() {
    function Datos(pedido, fecha, financiamiento, partida, programa, unidad, proveedor, iva,
    ...
    var pedidoCaptura = document.getElementById("pedido").value;
    ...
    total = new Datos(pedidoCaptura, fechaCaptura, financiamientoCaptura, partidaCaptura, programaCaptura,
  ...
  function adquirir() {
    ...
    if (reply == true) {
      for (var j = 0; j < base.length; j++) {
        ...
        var Doct = "Compra Directa"; 
        var Contrato = "";  
        var Pedido= base[j].pedido; 
